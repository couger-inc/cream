...
const BatchUpdateStateTreeVerifierSmall  = artifacts.require('BatchUpdateStateTreeVerifierSmall')
...
contract('MACIFactory', (accounts) => {
  ...
  describe('initialize', () => {
	it('should correctly initialized', async () => {
	  ...
	  assert.equal(batchUstVerifierAddress, batchUstVerifierInstance.address)
